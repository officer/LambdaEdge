...
This is a sample template for LambdaEdge - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name lambdaedge --tail
```
...
```bash
aws cloudformation delete-stack --stack-name lambdaedge
```
